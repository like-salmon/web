...
<img src="/Public/img/liliancp.png"/>
<!-- 产品内容-->
<div class="content llcp-cont">
    <div class="topleft">
        <img style="margin-left: -8px;" src="/Public/img/llcpicon.png"/>
    </div>
    <div class="price-cont">
        <div class="lcont">
            <ul class="utitle">
                ...
                <li data-target="ptab-sx" class="loca ct">
                    浙江绍兴
                </li>
                <li data-target="ptab-hz" class="loca ct">
                    浙江杭州
                </li>
            </ul>
        </div>
        ...
        <div class="shtabs" id="ptab-sx">
            <table>
                ...
                <tr>
                    ...
                    <td>1</td>
                    <td>500</td>
                    <td rowspan="4">集群防护100G，单机防护50G</td>
                </tr>
                <tr>
                    <td>绍兴电信</td>
                    <td>Q9</td>
            ...
            <table>
                ...
                <tr>
                    ...
                    <td>1</td>
                    <td>1200</td>
                    <td rowspan="4">集群防护240G，单机防护100G</td>
                </tr>
                <tr>
                    <td>绍兴电信</td>
                    <td>I5</td>
        ...
        <div class="shtabs" id="ptab-hz">
            <table>
                ...
                <tr>
                    ...
                    <td>1</td>
                    <td>2500</td>
                    <td ROWSPAN="2">集群防护380G，单机防护240G</td>
                </tr>
                <tr>
                    <td>杭州高防</td>
                    <td>E5620*2</td>
    ...
    <!-- <p id="talktokf"><a href="javascript:;">如需更多资源请联系在线客服</a></p>-->
</div>
<!-- 加载底部模板文件-->
﻿
<div id="footer">
...
<script type="text/javascript">
    $("document").ready(function () {
        //价格标签部分,IE为点击
        if($.checkIfIe()){
            $(".price-cont .types > li").on("click", function () {
                if ($(this).hasClass("active"))return;
                $(this).addClass("active").siblings().removeClass("active");
            });

        }else{
            $(".price-cont .types > li").on("mouseenter", function () {
                if ($(this).hasClass("active"))return;
                $(this).addClass("active").siblings().removeClass("active");
            });
        }
