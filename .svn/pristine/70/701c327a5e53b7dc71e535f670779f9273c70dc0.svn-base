<?php if (!defined('THINK_PATH')) exit();?>﻿<!-- 加载底部模板文件-->
<!doctype html>
<html>
<head>
    <meta charset="UTF-8">
...
<div class="slider">
    <ul>
        <li><a href="/products/lilian/"><img src="/Public/img/main1.png"/></a></li>
        <li><a href="products/server/"><img src="/Public/img/main2.png"/></a></li>
        <li><a href="products/gaofang/"><img src="/Public/img/main3.png"/></a></li>
    </ul>
</div>
<!-- 通知模块-->
<div class="nbar">
<div class="content notice reveal">
    <div class="left">
        <span class="red">新闻公告:</span>2016年国庆放假通知
    </div>
    <div class="right">
        <spanp>2016.11.9</spanp>
    </div>
</div>
</div>
<!-- 利联产品介绍模块-->
<div class="content products">
    ...
    <p class="desc">我们基于用户的需求主导产品研发，提供丰富、安全、易用、灵活的产品</p>
    <ul class="hpul">
        <li class="hp1"><a href="javascript:;"></a></li>
        <li class="hp2"><a href="javascript:;"></a></li>
        <li class="hp3"><a href="javascript:;"></a></li>
        <li class="hp4"><a href="javascript:;"></a></li>
        <li class="hp5"><a href="javascript:;"></a></li>
    </ul>
    <!--<div class="title">
        利联产品
    </div>
    <p class="desc">存储、计算、监控、安全...你所需要的一切云产品</p>
    <ul class="pul">
        <li class="p1"><a class="left" href="products/lilian/"></a><a class="right" href="javascript:;"></a></li>
        <li class="p2"><a class="left" href="products/lilian/"></a><a class="right" href="javascript:;"></a></li>
        <li class="p3"><a class="left" href="products/server/"></a><a class="right" href="javascript:;"></a></li>
        <li class="p4"><a class="left" href="products/gaofang/"></a><a class="right" href="javascript:;"></a></li>
    </ul>-->
</div>
<!--价格 -->
<!--
                    ...
                    <ul>
                        ...
                        <li class="lines active">
                            ...
                            <table>
                                ...
                                <tr>
                                    <td>厦门双线</td>
                                    <td style="margin-left: 5px">E5620*2</td>
                                    <td>16G</td>
                                    <td>1T</td>
                                    <td>G口50M带宽</td>
                                    <td>2</td>
                        ...
                        <li class="lines">
                            ...
                            <table>
                                ...
                                <tr>
                                    <td>东莞双线</td>
                                    <td style="margin-left: 5px">E5620*2</td>
                                    <td style="margin-left: 14px">16G</td>
                                    <td>1T</td>
                                    <td>G口50M</td>
                                    <td>2</td>
                                    <td>1500</td>
...
<!--服务 -->
<div id="service" class="imgrv">

</div>
<!-- 产品优势-->
<div id="advantage" class="imgrv">
...
<div class="content news">
    ...
    <ul class="pul">
        <li class="reveal"><a href="javascript:;">
            <div class="left">
                <img src="/Public/img/news3.png"/>
            </div>
            <div class="right">
                <p class="ptitle">优化机架配电-为您的数据中心环境选择最适合的机架配电装置的最佳方案</p>
                <p class="desc">随着数据信息日益成为许多企业组织背后最为强大的驱动力，数据中心现在业已成为了企业 业务成功运营的基础。在这种环境下，峰值期....
                </p>
        ...
        <li class="reveal"><a href="javascript:;">
            <div class="left">
                <img src="/Public/img/news1.png"/>
            </div>
            <div class="right">
                <p class="ptitle">2015年中国IDC市场规模达518.6亿元
                </p>
                <p class="desc">据该报告数据显示，2015年中国IDC市场延续了高速增长态势，市场总规模达到518.6亿元 人民币，同比增长39.3....
                </p>
                <span class="date">2016-12-09</span>
            </div></a>
        </li>
        <li class="reveal"><a href="javascript:;">
            <div class="left">
                <img src="/Public/img/news2.png"/>
            </div>
            <div class="right">
                <p class="ptitle">中国数据中心联盟华南区工作委员会正式成立</p>
                <p class="desc">文章摘自腾讯大粤网，原文标题：中国数据中心联盟华南区工作委员会主席团名单出炉7月 17日，中国数据中心产业发展联盟华南区工....
                </p>
                <span class="date">2016-12-09</span>
            </div></a>
        </li>
